...
- עבור מטופלים עם פרה-סוכרת, סוכרת, A1C גבוה, או כל מצב מטבולי — צום לסירוגין מחייב אישור רופא. אמור בבירור: "16:8 לא מתאים לכולם — עם פרה-סוכרת חשוב לא להתחיל בלי אישור רופא קודם, כי זה משפיע על רמות הסוכר"
